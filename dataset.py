...
def __music_feed_epoch(files,batch_size,seq_len,overlap,q_levels,q_zero,q_type,real_valued=False):
...
if __name__ == "__main__":
    BATCH_SIZE, SEQ_LEN, OVERLAP, Q_LEVELS, Q_ZERO, Q_TYPE = 3 , 2**15, 1000, 2**16, 2**16//2, 'linear'
    
    generator = music_train_feed_epoch(BATCH_SIZE, SEQ_LEN, OVERLAP, Q_LEVELS, Q_ZERO, Q_TYPE)
    a = generator.next()
    import pdb; pdb.set_trace()